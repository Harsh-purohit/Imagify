...
const Navbar = () => {
    ...
    <div className='flex justify-between items-center py-4 '>
        ...
        <div>
            ...
            {user   //used ternary operator for conditional rendering
            ? 
            <div className='flex gap-2 items-center sm:gap-3'>
                <button onClick={()=>navigate('/buy')} className='flex items-center gap-2 bg-blue-100 px-4 sm:px-6 py-1.5 sm:py-3 rounded-full hover:scale-105 transition-all duration-7   00'>
